...
import {
  CreatePropertyWalletProjectStep1Dto,
  CreatePropertyWalletProjectStep2Dto,
  CreatePropertyWalletProjectStep3Dto,
  PropertyWalleSearchDto,
  UpdateDocumentStep2Dto,
} from './dto/create-property_wallet_project.dto';
import {
  UpdatePropertyWalletProjectStep1Dto,
  UpdatePropertyWalletProjectStep3Dto,
} from './dto/update-property_wallet_project.dto';
import { Connection, getRepository } from 'typeorm';
import { PropertyWalletProject } from './entities/property_wallet_project.entity';
import { commonMessage } from 'src/common/messages';
import { ResponseDto } from 'src/common/response.dto';
import { S3 } from 'aws-sdk';
import { PropertyWalletProjectDocument } from './entities/property_wallet_projectDocument.entity';
...
@Injectable()
export class PropertyWalletProjectService {
  constructor(
